    ...
    if (!empty($product_categories) || !empty($products) || !empty($products_in_cat) ) {
      ...
      if (!empty($product_categories)) {
        foreach ($product_categories as $product_cateory) {
          ...
          '
          <li>
             <a class="uk-link-text" href="' . get_term_link($product_cateory) . '">
      ...
      if (!empty($products)) {
        foreach ($products as $product) {
          ...
          '
          <li>
             <a class="uk-link-text" href="' .get_permalink($product->id) . '">
               <div class="uk-grid-small uk-flex uk-flex-middle" uk-grid>
                 <div class="uk-width-expand">
                   ' . $product->name . ' 
                 </div>
      ...
      if (!empty($products_in_cat)) {
        foreach ($products_in_cat as $product_in_cat) {
          ...
          '
          <li>
             <a class="uk-link-text" href="' . get_permalink($product_in_cat->id) . '">
               <div class="uk-grid-small uk-flex uk-flex-middle" uk-grid>
                 <div class="uk-width-expand">
