<?php
/**
 * Widget API: Vigilant_Octo_Telegram_Custom_UIKIT_Widget_Class class
 *
 */
 ...
 * @see WP_Widget
 */
class Vigilant_Octo_Telegram_Custom_UIKIT_Widget_Class extends WP_Widget
{
    ...
    public function _register_one($number = -1)
    {
        ...
        add_action('admin_footer-widgets.php', array( 'Vigilant_Octo_Telegram_Custom_UIKIT_Widget_Class', 'render_control_template_scripts' ));

        // Note this action is used to ensure the help text is added to the end.
        add_action('admin_head-widgets.php', array( 'Vigilant_Octo_Telegram_Custom_UIKIT_Widget_Class', 'add_help_text' ));
    }
    ...
    public function widget($args, $instance)
    {
         ...
         * @param Vigilant_Octo_Telegram_Custom_UIKIT_Widget_Class $this     Current Custom HTML widget instance.
         */
     ...
     *
     * @since 4.8.1
     * @since 4.9.0 The form contains only hidden sync inputs. For the control UI, see `Vigilant_Octo_Telegram_Custom_UIKIT_Widget_Class::render_control_template_scripts()`.
     *
     * @see Vigilant_Octo_Telegram_Custom_UIKIT_Widget_Class::render_control_template_scripts()
